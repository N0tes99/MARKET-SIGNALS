...
**Surfaces:** (1) asset ranking, (2) crypto setups, (3) equity options (MVP), (4) Runner Detection / 10X Radar — **planned** (M10; does not alter 13-category grades). Plan: `docs/research/10x-runner-detection-layer.md`.
