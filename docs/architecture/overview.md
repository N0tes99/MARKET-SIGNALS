...
**Surfaces:** (1) asset ranking, (2) crypto setups, (3) equity options (MVP), (4) Runner Detection / 10X Radar — **Phase 2 preview** (structure + optional cap; `/radar` labeled preview; fundamentals TBD). Plan: `docs/research/10x-runner-detection-layer.md`. (5) Expansion radar + cortex. (6) **Rail** — nested `/rail` blind clerk, Phase A paper-only. Plan: `docs/research/rail-execution-surface.md`. Signal Engine Surfaces 1–5 stay intelligence-only.
