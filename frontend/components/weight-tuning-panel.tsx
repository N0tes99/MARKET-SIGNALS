    ...
    <div className="surface bg-card p-5 lg:col-span-2">
      ...
      {!isActive && (
        <button
          ...
          className="mt-4 border border-border px-4 py-2 font-mono text-xs uppercase tracking-widest transition-colors hover:border-foreground/30 hover:bg-accent disabled:opacity-50"
        >
